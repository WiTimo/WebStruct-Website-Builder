...
export default function Headline({style, setStyle, html, setHtml, index }) {
    ...
    return(
        <div className="elements-container">
            ...
            <input className="style-input" id="id-input" name="id-input" placeholder="Headline" onChange={(e) => changeH1Text(e)}/>
