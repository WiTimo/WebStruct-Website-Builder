        ...
        <div className="border-container">
            <label htmlFor="border">Border: </label>
                <div className="border-options">
                    ...
                    <input id="border-width" name="border-width" type="number" value={borderWidth} onChange={(e) => {setBorderWidth(e.target.value); changeStyle("border", `${e.target.value}px ${borderStyle} ${borderColor}`)}} />
