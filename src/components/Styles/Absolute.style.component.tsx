...
export default function Position({object, changeStyle, resetStyle}){
    ...
    return(
        <div className="position-container">
            ...
            <select id="position" name="position" value={object["position"] ? object["position"] : "static"} onChange={(e) => changeStyle("position", e.target.value)}>
            ...
            <div>Position absolute/fixed/sticky needed</div>
                <div className="absolute-options">
                    <div className="absolute-left-options">
                        ...
                        <input id="left" name="left" type="number" value={object["left"] ? object["left"][0] : "0"} onChange={(e) => changeStyle("left", `${e.target.value}`, document.querySelector("#left-unit-dropdown").value, true)} />
                    ...
                    <label htmlFor="top">Y-Axis: </label>
                        ...
                        <input id="top" name="top" type="number" value={object["top"] ? object["top"][0] : "0"} onChange={(e) => changeStyle("top", `${e.target.value}`, document.querySelector("#top-unit-dropdown").value, true)} />
